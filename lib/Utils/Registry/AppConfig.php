...
class AppConfig
{
    ...
    /** @var array<string, array<string, array{class: string, label?: string}>> */
    public static array $SUPPORTED_FILE_TYPES = [
        ...
        'Documents' => [
            ...
            'ots' => ['class' => 'extxls'],
            'tsv' => ['class' => 'extxls'],
            // the accepted extension is 'key'; 'keynote' is shown only as a label
            'key' => ['class' => 'extppt', 'label' => 'key/keynote'],
            'ppt' => ['class' => 'extppt'],
            'pps' => ['class' => 'extppt'],
            'pptx' => ['class' => 'extppt'],
            'pptm' => ['class' => 'extppt'],
        ...
        'Markup and Structured Data' => [
            ...
            'yaml' => ['class' => 'extxml'],
            'yml' => ['class' => 'extxml'],
            'properties' => ['class' => 'extpro'],
            'resx' => ['class' => 'extres'],
            'strings' => ['class' => 'extstr'],
            'md' => ['class' => 'extxml'],
            'dita' => ['class' => 'extdit'],
            'wix' => ['class' => 'extwix'],
            'ditamap' => ['class' => 'extdit'],
            //'php'  => ['class' => 'extxml'],
        ],
        'Images' => [
            'bmp' => ['class' => 'extimg'],
