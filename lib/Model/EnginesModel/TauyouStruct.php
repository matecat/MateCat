 ...
 *
 */
class EnginesModel_TauyouStruct extends EnginesModel_EngineStruct {

    /**
     * @var string
     */
    public $description = "Tauyou Engine";
     ...
     * @var string
     */
    public $class_load = Constants_Engines::TAUYOU;
    ...
    public static function getStruct() {
        return new EnginesModel_TauyouStruct();
    }
