...
namespace Model\Conversion\MimeTypes\Constants;
...
class MimeTypesMap {
    ...
    public const REVERSE_MAP = [
            ...
            'iso'                      => [
                    'application/vnd.efi.iso', 'application/x-cd-image', 'application/x-dreamcast-rom', 'application/x-gamecube-iso-image', 'application/x-gamecube-rom', 'application/x-iso9660-image', 'application/x-saturn-rom', 'application/x-sega-cd-rom', 'application/x-sega-pico-rom', 'application/x-wbfs', 'application/x-wia', 'application/x-wii-iso-image', 'application/x-wii-rom'
            ],
