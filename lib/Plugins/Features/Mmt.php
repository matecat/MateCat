...
class Mmt extends BaseFeature
{
     ...
     */
    public static function bootstrapCompleted(): void
    {
     ...
     *     engineData: array<string,string>
     * }
     *
     *
     ...
     *
     */
    public function buildNewEngineStruct(object $data): ?EngineStruct
    {
     ...
     */
    public function postTMKeyCreation(array $memoryKeyStructs, int $uid): void
    {
