...
class ChunkReviewModel extends \Features\ReviewExtended\ChunkReviewModel {
    ...
    public function recountAndUpdatePassFailResult() {
        ...
        $this->chunk_review->reviewed_words_count =
                ( new ChunkReviewDao())->getReviewedWordsCountForSecondPass( $chunk, $this->chunk_review->source_page ) ;

        $this->chunk_review->advancement_wc = ( new \Features\SecondPassReview\Model\ChunkReviewDao($this->chunk_review))->recountAdvancementWords(
