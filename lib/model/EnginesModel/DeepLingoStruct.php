 ...
 *
 */
class EnginesModel_DeepLingoStruct extends EnginesModel_EngineStruct {

    /**
     * @var string
     */
    public $description = "DeepLingo Engine";
     ...
     * @var string
     */
    public $class_load = Constants_Engines::DEEPLINGO;
    ...
    public static function getStruct() {
        return new EnginesModel_DeepLingoStruct();
    }
