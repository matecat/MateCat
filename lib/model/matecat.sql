...
) ENGINE=MyISAM AUTO_INCREMENT=2772 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `segment_translations` (
  ...
  `serialized_errors_list` varchar(50) DEFAULT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=1768050 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `engines` VALUES (1,'MyMemory (All Pairs)','TM','MyMemory: next generation Translation Memory technology','http://mymemory.translated.net/api','
get','set','delete',NULL,'1',0),(2,'FBK-IT (EN->IT)','MT','FBK (EN->IT) Moses Information Technology engine','http://hlt-services2.fbk.eu:8480','translate',
'update',NULL,NULL,'2',14),(3,'LIUM-IT (EN->DE)','MT','Lium (EN->FR) Moses Information Technology engine','http://193.52.29.66:8001','translate',NULL,NULL,N
ULL,'2',14),(4,'FBK-LEGAL (EN>IT)','MT','FBK (EN->IT) Moses Legal engine','http://hlt-services2.fbk.eu:8490','translate',NULL,NULL,NULL,'2',14),(5,'LIUM-LEG
AL (EN->DE)','MT','Lium (EN->FR) Moses Legal engine','http://193.52.29.52:8001','translate',NULL,NULL,NULL,NULL,14),(6,'TEST PURPOSE FBK (EN->IT)','MT','TES
T PURPOSE ONLY  - FBK (EN->IT)','http://hlt-services2.fbk.eu:8482','translate','update',NULL,NULL,'2',14);
...
-- Dump completed on 2013-03-24 22:46:08
