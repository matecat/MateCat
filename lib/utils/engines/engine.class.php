...
abstract class Engine {
    ...
    public function __construct( $id ) {
        ...
        $extra_data = json_decode( $data['others'], true );
        ...
        $this->gloss_get_url           = $extra_data[ 'gloss_get_relative_url' ];
        $this->gloss_set_url           = $extra_data[ 'gloss_set_relative_url' ];
        $this->gloss_update_url        = $extra_data[ 'gloss_update_relative_url' ];
        $this->gloss_delete_url        = $extra_data[ 'gloss_delete_relative_url' ];
        $this->tmx_import_url          = $extra_data[ 'tmx_import_relative_url' ];
