...
class getVolumeAnalysisController3 extends ajaxcontroller {
    private $id_project;
    ...
    public function doAction() {
        ...
        $res = getProjectStatsVolumeAnalysis2($this->id_project);
...
//print_r ($return_data);exit;
        ...
        foreach ($res as $r) {
           ...
           // log::doLog("$this->id_project - " . $r['status_analysis'] . "  analyzed $this->segments_analyzed");
            ...
            if ($this->total_wc_fast_analysis == 0 and $r['fast_analysis_wc'] > 0) {
                ...
                //$this->total_wc_standard_analysis = $r['fast_analysis_wc'];
            }
            ...
            // echo "ciao " .$r['fast_analysis_wc'] . " --- ". $this->total_wc_tm_analysis. "\n";
            ...
            // if ($this->total_wc_standard_analysis == 0 and $r['standard_analysis_wc'] > 0) {
            //     $this->total_wc_standard_analysis = $r['standard_analysis_wc'];
            // }
            ...
            //log::doLog("- $this->total_wc_tm_analysis");
            
            //else {
            //    $this->total_wc_tm_analysis+=$r['tm_analysis_wc']; //volume analysis ancora in corso
            //}
            //echo "ciaooo" .$r['tm_analysis_wc'] . " --- ". $this->total_wc_tm_analysis. "\n\n";
            //continue;
            ...
            if ($r['match_type'] == "50%-74%" or $r['match_type'] == "NO_MATCH" or $r['match_type'] == "NEW") {
                ...
                //echo "new w before is ". $return_data ['jobs'][$jid]['file_details'][$r['id_file']]["NEW"][0]. "\n";
                $w = $return_data ['jobs'][$jid]['file_details'][$r['id_file']]["NEW"][0] + $words;
                $words_print = number_format($w, 0, ".", ",");
                //echo "new w after is $w\n\n";
        ...
        //echo $this->total_wc_tm_analysis; exit;
        ...
        //$standard_wc_time = ceil($standard_wc_time);
        //$fast_wc_time = ceil($fast_wc_time);
        //$tm_wc_time = ceil($tm_wc_time);
	...
	if ($this->segments_analyzed>0 and $this->total_segments==$this->segments_analyzed){
        ...
        //VERIFY FOLLOWING DATA : STANDARD_WC_DATA has been deleted
        ...
        //NON ANCORA VALORIZZATI: IN ATTESA DELLA ANALISI COMPLETA 
        //DELETE
        //  print_r($return_data);
        //  exit;
