...
class convertFileController extends ajaxcontroller {
	...
	public function doAction() {
		...
		log::doLog('preparing to convert file ' . $this->file_name.' from '.$this->source_lang.' to '.$this->target_lang);
		...
		if (!empty($xliffContent)) {
			...
			//this is necessary to avoid Trados Converter crash: send only one target language in multitarget projects
