...
class GetSearchController extends AbstractStatefulKleinController
{
     ...
     * @throws Exception
     */
    private function updateSegments(array $search_results, int $id_job, string $password, ?string $id_segment, SearchQueryParamsStruct $queryParams, ?int $revisionNumber = null): void
    {
        $db = Database::obtain();
