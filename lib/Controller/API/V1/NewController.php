...
class NewController extends KleinController {
    ...
    private function validateTheRequest(): array {
        ...
        //YYY DEFAULT MIN MUST BE 76
        $mt_quality_value_in_editor                = filter_var( $this->request->param( 'mt_quality_value_in_editor' ), FILTER_SANITIZE_NUMBER_INT, [ 'filter' => FILTER_VALIDATE_INT, 'flags' => FILTER_REQUIRE_SCALAR, 'options' => [ 'default' => 86, 'min_range' => 50, 'max_range' => 102 ] ] ); // used to set the absolute value of an MT match (previously fixed to 85)
