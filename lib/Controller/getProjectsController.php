...
class getProjectsController extends ajaxController {
    ...
    public function doAction() {
         ...
         * Review password may be needed or not depending on the project. Some projects may need
         * a separate review password, others not. Even thought the feature is disable for the
         * given project, the password. Given this recordset is paginated, it may be feasible to
         * seek for a revision password for each of them in a separate query.
         *
         */

        $projects = Features::filter('filter_manage_projects_loaded',  $_SESSION['cid'], $projects);
