...
class RenameTeams extends AbstractMatecatMigration
{
    ...
    public $sql_up = array(
        ...
        " ALTER TABLE teams_users DROP INDEX id_team_uid, ADD INDEX id_organization_uid (id_organization, uid) ",
        " ALTER TABLE teams_users RENAME TO organizations_users " ,
        " ALTER TABLE owner_features CHANGE id_team id_organization int(11) ",
        " ALTER TABLE owner_features DROP INDEX id_team_feature, ADD INDEX id_organization_feature(id_organization,feature_code) ",
    ...
    public $sql_down = array(
        ...
        " ALTER TABLE owner_features DROP INDEX id_organization_feature, ADD INDEX id_team_feature (id_team,feature_code) ",
