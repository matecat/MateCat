  ...
  paths: {
    ...
    '/api/v3/jobs/{id_job}/{password}/translation-issues': {
      get: {
        ...
        summary: 'Retrieve a complete list of all revision issues in a job',
        description: 'Retrieve a complete list of all revision issues in a job',
        parameters: [
          {
            name: 'id_job',
            in: 'path',
    ...
    '/api/v3/context-url/schema': {
      get: {
        tags: ['Context URL'],
        summary: 'Get validation schema for context URL',
        description: 'Returns the JSON schema used to validate context URL request bodies.',
        parameters: [],
        responses: {
          200: {
            description: 'The JSON validation schema.',
            schema: {
              $ref: '#/definitions/ContextUrlSchema',
            },
          },
          default: {
            description: 'Unexpected error',
    ...
    '/api/v3/context-url/{id_project}/{password}/project': {
      post: {
        tags: ['Context URL'],
        ...
        parameters: [
          ...
          },
          {
            name: 'body',
            in: 'body',
            description: 'The context URL to set',
            required: true,
            schema: {
              type: 'object',
        ...
        responses: {
          200: {
            ...
            schema: {
              $ref: '#/definitions/ContextUrlProjectResponse',
            },
          },
          400: {
            description: 'Invalid request body or missing context_url',
          },
          401: {
    ...
    '/api/v3/context-url/{id_project}/{password}/file': {
      post: {
        tags: ['Context URL'],
        ...
        parameters: [
          ...
          },
          {
            name: 'body',
            in: 'body',
            description: 'The context URL and file ID',
            required: true,
            schema: {
              type: 'object',
              required: ['context_url', 'id_file'],
              properties: {
                context_url: {
                  type: 'string',
                  format: 'uri',
        ...
        responses: {
          200: {
            description: 'Context URL set successfully.',
            schema: {
              $ref: '#/definitions/ContextUrlFileResponse',
            },
          },
          400: {
            description: 'Invalid request body or missing id_file',
          },
          401: {
            description: 'Authentication required',
          },
          403: {
            description: 'File does not belong to this project',
          },
          404: {
    ...
    '/api/v3/context-url/{id_project}/{password}/segment': {
      post: {
        tags: ['Context URL'],
        ...
        parameters: [
          ...
          },
          {
            name: 'body',
            in: 'body',
            description: 'The context URL and segment ID',
            required: true,
            schema: {
              type: 'object',
              required: ['context_url', 'id_segment'],
              properties: {
                context_url: {
                  type: 'string',
                  format: 'uri',
        ...
        responses: {
          200: {
            description: 'Context URL set successfully.',
            schema: {
              $ref: '#/definitions/ContextUrlSegmentResponse',
            },
          },
          400: {
            description: 'Invalid request body or missing id_segment',
          },
          401: {
            description: 'Authentication required',
          },
          403: {
            description: 'Segment does not belong to this project',
          },
          404: {
            description: 'Project or segment not found',
          },
          429: {
            description: 'Rate limit exceeded',
          },
