  ...
  ;(function (Review, $) {
    ...
    $('html')
      .on('open', 'section', function () {
        if (
          ...
          !$(this).find('.tab-switcher-review').hasClass('active')
        ) {
    ...
    $.extend(UI, {
      ...
      trackChanges: function () {
        ...
        var diffHTML = TextUtils.trackChangesHTML(
          TextUtils.htmlEncode(source),
          TextUtils.htmlEncode(target),
        )
