...
class CattoolFooter extends React.Component {
    constructor(props) {
        ...
        this.sourceLang = this.props.languagesArray.find((item) => item.code === this.props.source ).name;
        this.targetLang = this.props.languagesArray.find((item) => item.code === this.props.target ).name;
    }
    ...
    render () {
        return <div className="footer-body">
                    {/*// <!-- job id -->*/}
                    <div className="item">
                        <p id="job_id">Job ID: <span>{this.props.idJob}</span></p>
                    </div>
            ...
            {/*// <!-- progress -->*/}
                ...
                <div className="progress-bar">
                    ...
                    <div className="percent"><span id="stat-progress">{this.state.stats ? this.state.stats.PROGRESS_PERC_FORMATTED : "-"}</span>%</div>
                </div>
                ...
                <div className="statistics-core">
                    <div id="stat-eqwords">
                        {config.allow_link_to_analysis ? (
                            <a target="_blank" href={"/jobanalysis/"+ this.props.idProject +"-"+ this.props.idJob +"-"+ this.props.password}>
                                { !this.props.isCJK ? (
                         ...
                         :
                        <strong id="total-payable"> {this.state.stats ? this.state.stats.TOTAL_FORMATTED : "-" }</strong>
                    </div>
                </div>
            ...
            <div className="item">
                { this.props.isReview ? (
                    <div id="stat-todo"><span>To-do</span> : <strong>{this.state.stats ? this.state.stats.revise_todo_formatted : "-"}</strong></div>
                ) : (
                    <div id="stat-todo"><span>To-do</span> : <strong>{this.state.stats ? this.state.stats.TODO_FORMATTED : "-"}</strong></div>
                ) }
            </div>
            ...
            { _.isUndefined(this.state.stats) || !this.state.stats.ANALYSIS_COMPLETE ? (
                <div id="analyzing">
