                ...
                <div className={containerClass} ref={(node) => (this.el = node)}>
                    <div className="re-item-box re-issue shadow-1">
                        <div className="issue-head pad-right-10">
                            ...
                            <b>
                                <span title="Type of severity">[{this.props.issue.severity.substring(0, 3)}]</span>
                            </b>
                        </div>
                        <div className="issue-activity-icon">
                            {this.props.actions && (
                                <div className="icon-buttons">
                                    <button
                                        className={'ui icon basic tiny button issue-note ' + commentViewButtonClass}
                                    ...
                                    {this.props.isReview &&
                                    this.props.issue.revision_number <= this.props.currentReview ? (
                                        <button
