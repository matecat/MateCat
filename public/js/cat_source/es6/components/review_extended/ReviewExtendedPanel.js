    ...
    render() {
        ...
        return (
            <div className={'re-wrapper shadow-1 ' + thereAreIssuesClass}>
                ...
                <a className="re-close-balloon re-close-err shadow-1" onClick={this.closePanel.bind(this)}>
                ...
                {this.state.showAddIssueMessage ? (
                    <div className="re-warning-not-added-issue">
                        <p>
                            In order to Approve the segment you need to add an Issue from the list below.
                            <br />
                            <a onClick={() => APP.ModalWindow.showModalComponent(ShortCutsModal, null, 'Shortcuts')}>
                                {'Shortcut: ' +
                                    Shortcuts.cattol.events.navigateIssues.equivalent[Shortcuts.shortCutsKeyType]}
                            </a>
                            .
                        </p>
                    </div>
                ...
                {this.props.isReview && !(this.props.segment.ice_locked == 1 && !this.props.segment.unlocked) ? (
