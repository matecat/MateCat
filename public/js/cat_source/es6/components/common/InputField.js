    ...
    render() {
        ...
        return (
            <div className={"qr-filter-idSegment"} style={styleContainer}>
                <input style={styleInput} type={type} placeholder={this.props.placeholder}
                       value={this.state.value} name={this.props.name} onChange={this.handleChange} className={this.props.classes}  tabIndex={this.props.tabindex}
