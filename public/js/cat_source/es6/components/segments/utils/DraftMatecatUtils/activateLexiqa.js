...
const activateLexiqa = (editorState, lexiqaWarnings, sid, isSource, getUpdatedSegmentInfo) => {
    ...
    return generateLexiqaDecorator( lexiqaWarnings, sid, isSource, DraftMatecatConstants.LEXIQA_DECORATOR )
};
