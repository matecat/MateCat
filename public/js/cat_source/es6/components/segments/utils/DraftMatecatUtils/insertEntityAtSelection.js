 ...
 */
const insertEntityAtSelection = (editorState, entityBlueprint, selectionState = null) => {
    const selection = selectionState ? selectionState : editorState.getSelection();
    // Create entity
    const {editorState: editorStateWithEntity, entityKey} = entityBuilder(editorState, entityBlueprint);
    ...
    editorStateUpdated = EditorState.forceSelection(editorStateUpdated, newSelection);
