...
class ProjectsContainer extends React.Component {
    ...
    getButtonsNoProjects() {
        ...
        let thereAreMembers =
            (this.state.team.get('members') && this.state.team.get('members').size > 1) ||
            (this.state.team.get('pending_invitations') && this.state.team.get('pending_invitations').size > 0) ||
    ...
    render() {
        ...
        if (this.state.more_projects && projects.size > 9) {
            ...
            spinner = (
                <div className="ui one column grid" ref={(spinner) => (this.spinner = spinner)}>
