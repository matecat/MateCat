...
class JobContainer extends React.Component {
    ...
    getOutsourceButton() {
        ...
        let label = <a className="open-outsource buy-translation ui button"
    ...
    render () {
        ...
        if (this.props.project.has('features') && this.props.project.get('features').indexOf('second_pass_review') > -1 && this.props.job.get('stats').has('revises')
            ...
            approvedPerc = (approved) ? approved.get('advancement_wc')*100/this.props.job.get('stats').get('TOTAL') : approvedPerc;
            ...
            approvedPerc2ndPass = (approved2ndPass) ? approved2ndPass.get('advancement_wc')*100/this.props.job.get('stats').get('TOTAL') : approved2ndPass;
                        ...
                        <div className="progress-bar">
                            <div className="progr">
                                <div className="meter">
                                    ...
                                    <a className="approved-bar translate-tooltip" data-variation="tiny" data-html={'Approved '+ approvedPercFormatted +'%'} style={{width: approvedPerc+ '%' }}
                                       ref={(tooltip) => this.approvedTooltip = tooltip}/>
                                    { approvedPercFormatted2ndPass ? (
                                        <a className="approved-bar-2nd-pass translate-tooltip" data-variation="tiny" data-html={'Approved '+ approvedPercFormatted2ndPass +'%'} style={{width: approvedPerc2ndPass+ '%' }}
