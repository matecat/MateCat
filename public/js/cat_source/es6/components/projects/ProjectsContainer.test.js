...
const fakeProjectsData = {
  projects: {
    data: [
      {
        id: 17,
        password: '3d17443dd94c',
        name: 'TestXLIFF',
        id_team: 1,
        id_assignee: 1,
        create_date: '2021-07-14 16:18:43',
        fast_analysis_wc: 4,
        standard_analysis_wc: 4,
        tm_analysis_wc: '3.20',
        project_slug: 'testxliff',
        jobs: [
          {
            id: 110,
            password: '9599a9febd1e',
            source: 'en-US',
            target: 'es-ES',
            sourceTxt: 'English US',
            targetTxt: 'Spanish',
            job_first_segment: '156',
            status: 'active',
            subject: 'general',
            subject_printable: 'General',
            owner: 'pierluigi.dicianni@translated.net',
            open_threads_count: 0,
            create_timestamp: 1626272323,
            created_at: '2021-07-14T16:18:43+02:00',
            create_date: '2021-07-14 16:18:43',
            formatted_create_date: 'Today, 16:18',
            ...
            revise_passwords: [{revision_number: 1, password: '5232e90c880b'}],
            urls: {
              password: '9599a9febd1e',
              translate_url:
                'https://dev.matecat.com/translate/TestXLIFF/en-US-es-ES/110-9599a9febd1e',
              revise_urls: [
                {
                  revision_number: 1,
                  url: 'https://dev.matecat.com/revise/TestXLIFF/en-US-es-ES/110-5232e90c880b',
                },
              ],
              original_download_url:
                'https://dev.matecat.com/?action=downloadOriginal&id_job=110&password=9599a9febd1e&download_type=all&filename=12',
        ...
        jobs: [
          {
            ...
            revise_passwords: [
              {revision_number: 1, password: '25a2513040eb'},
              {revision_number: 2, password: '6688b6b321de'},
            ],
            urls: {
              password: 'defe9aad39e3',
              translate_url:
              ...
              revise_urls: [
                ...
                {
                  revision_number: 2,
                  url: 'https://dev.matecat.com/revise2/Test/en-US-la-XN/98-6688b6b321de',
                },
              ],
              original_download_url:
        ...
        jobs: [
          {
            ...
            revise_passwords: [
              {revision_number: 1, password: '9084da7a0d31'},
              {revision_number: 2, password: '259b6eb9e62f'},
            ],
            urls: {
              password: '2a35d508882e',
              translate_url:
