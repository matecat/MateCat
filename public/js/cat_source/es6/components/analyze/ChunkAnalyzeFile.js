class ChunkAnalyzeFile extends React.Component {
    ...
    checkWhatChanged() {
        if (this.file) {
            this.dataChange.TOTAL_PAYABLE =     !(this.file.get('TOTAL_PAYABLE').equals(this.props.file.get('TOTAL_PAYABLE')));
            this.dataChange.NEW =               !(this.file.get('NEW').equals(this.props.file.get('NEW')));
            this.dataChange.REPETITIONS =       !(this.file.get('REPETITIONS').equals(this.props.file.get('REPETITIONS')));
            this.dataChange.INTERNAL_MATCHES =  !(this.file.get('INTERNAL_MATCHES').equals(this.props.file.get('INTERNAL_MATCHES')));
            this.dataChange.TM_50_74 =          !(this.file.get('TM_50_74').equals(this.props.file.get('TM_50_74')));
            this.dataChange.TM_75_84 =          !(this.file.get('TM_75_84').equals(this.props.file.get('TM_75_84')));
            this.dataChange.TM_85_94 =          !(this.file.get('TM_85_94').equals(this.props.file.get('TM_85_94')));
            this.dataChange.TM_95_99 =          !(this.file.get('TM_95_99').equals(this.props.file.get('TM_95_99')));
            this.dataChange.TM_100 =            !(this.file.get('TM_100').equals(this.props.file.get('TM_100')));
            this.dataChange.TM_100_PUBLIC =     !(this.file.get('TM_100_PUBLIC').equals(this.props.file.get('TM_100_PUBLIC')));
            this.dataChange.ICE =               !(this.file.get('ICE').equals(this.props.file.get('ICE')));
            this.dataChange.MT =                !(this.file.get('MT').equals(this.props.file.get('MT')));
        }
        ...
        return <div className="chunk-detail sixteen wide column pad-right-10">
            ...
            <div className="single-analysis">
                ...
                <div className="single tm-public"
                    ...
                    {file.TM_100_PUBLIC[1]}</div>
                <div className="single tm-context"ref={(container) => this.containers['ICE'] = container}>
                    {file.ICE[1]}</div>
