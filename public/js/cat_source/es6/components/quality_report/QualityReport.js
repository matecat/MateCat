...
class QualityReport extends React.Component {
    ...
    render() {
        ...
        if (this.state.jobInfo) {
            quality_summary = this.state.jobInfo.get('quality_summary').find((value) => {
                return value.get('revision_number') === parseInt(this.state.revisionToShow);
            });
        }
        return (
                                                ...
                                                <div className={'filter-reviewType active'}>
                                                    ...
                                                    >
                                                        {this.state.revisionToShow === '1' ? (
                                                            <div className="text">
                                                                <div
                                                                    className={'ui revision-color empty circular label'}
                                                                />
                                                                Revision
                                                            </div>
                                                        ) : (
