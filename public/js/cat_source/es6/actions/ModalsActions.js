let ModalsActions = {
    ...
    openOutsourceModal: function (project, job, url, fromManage, translatorOpen, showTranslatorBox) {
        var props = {
            project: project,
            job: job,
            url: url,
            ...
            showTranslatorBox: (!_.isUndefined(showTranslatorBox)) ? showTranslatorBox : true
        };
