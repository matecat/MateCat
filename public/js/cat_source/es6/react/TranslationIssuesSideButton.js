...
export default React.createClass({
    ...
    render: function() {
        ...
        if ( count > 0 ) {
            ...
            return (<div onClick={this.handleClick}><a className="revise-button" href="javascript:void(0);"><span className="icon-error_outline" /><span className="revise-button-counter">+</span></a></div>);
        }
