...
class ChunkAnalyzeHeader extends React.Component {
    ...
    checkWhatChanged() {
        if (this.total) {
            this.dataChange.TOTAL_PAYABLE =     !(this.total.get('TOTAL_PAYABLE').equals(this.props.total.get('TOTAL_PAYABLE')));
            this.dataChange.NEW =               !(this.total.get('NEW').equals(this.props.total.get('NEW')));
            this.dataChange.REPETITIONS =       !(this.total.get('REPETITIONS').equals(this.props.total.get('REPETITIONS')));
            this.dataChange.INTERNAL_MATCHES =  !(this.total.get('INTERNAL_MATCHES').equals(this.props.total.get('INTERNAL_MATCHES')));
            this.dataChange.TM_50_74 =          !(this.total.get('TM_50_74').equals(this.props.total.get('TM_50_74')));
            this.dataChange.TM_75_84 =          !(this.total.get('TM_75_84').equals(this.props.total.get('TM_75_84')));
            this.dataChange.TM_85_94 =          !(this.total.get('TM_85_94').equals(this.props.total.get('TM_85_94')));
            this.dataChange.TM_95_99 =          !(this.total.get('TM_95_99').equals(this.props.total.get('TM_95_99')));
            this.dataChange.TM_100 =            !(this.total.get('TM_100').equals(this.props.total.get('TM_100')));
            this.dataChange.TM_100_PUBLIC =     !(this.total.get('TM_100_PUBLIC').equals(this.props.total.get('TM_100_PUBLIC')));
            this.dataChange.ICE =               !(this.total.get('ICE').equals(this.props.total.get('ICE')));
            this.dataChange.MT =                !(this.total.get('MT').equals(this.props.total.get('MT')));
        }
    ...
    render() {
        ...
        let id = (this.props.chunksSize > 1) ? this.props.jobInfo.jid + '-' +this.props.index : this.props.jobInfo.jid;
