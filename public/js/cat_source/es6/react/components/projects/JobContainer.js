...
class JobContainer extends React.Component {
    ...
    render () {
        ...
        if (this.props.project.has('features') && this.props.project.get('features').indexOf('second_pass_review') > -1 && this.props.job.get('stats').has('reviews') && this.props.job.get('stats').get('reviews').size > 1){
