...
LXQ.init  = function () {
    ...
    return (function ($, config, window, LXQ, undefined) {
        ...
        var warningMesasges = {
            u2: {
                t: 'email not found in source',
                s: 'email missing from target'
            },
            u1: {
                t: 'url not found in source',
                s: 'url missing from target'
            },
            n1: {
                t: 'index not found in source',
                s: 'index missing from target'
            },
            n2: {
                t: 'number not found in source',
            ...
            p1: {
                t: 'consecutive punctuation marks',
                s: ''
            },
            p2: {
                t: 'space before punctuation mark',
                s: ''
            },
            p2sub1: {
                t: 'space before punctuation mark missing',
                s: ''
            },
            p2sub2: {
                t: 'no space before opening parenthesis',
                s: ''
            },            //initCommentLinks();

            p3: {
                t: 'space after punctuation mark missing',
                s: ''
            },
            p3sub1: {
                t: 'no space after closing parenthesis',
                s: ''
            },
            p4: {
            ...
            p6: {
                t: 'should be capitalized after punctuation mark',
                s: ''
            },
            l1: {
                t: 'repeated word',
            ...
            c2: {
                t: 'segment starting with space',
                s: ''
            },
            c2sub1: {
                t: 'space found after opening bracket/parenthesis',
                s: ''
            },
            c3sub1: {
                t: 'space found before closing bracket/parenthesis',
                s: ''
            },
            c3: {
                t: 'space found at the end of segment',
                s: ''
            },
            s2: {
                t: 'foreign character',
            ...
            s3sub1: {
                t: 'bracket not closed',
                s: ''
            },
            s3sub2: {
                t: 'bracket not opened',
                s: ''
            },
            s4: {
        ...
        // There is not trigger for this event ??
        ...
        var highLightText = function (text, results, isSegmentCompleted, showHighlighting, isSource, segment) {
            ...
            for (var k = 0; k < tags.length - 1; k++) {
                if ((tags[k][0] + tags[k][1] == tags[k + 1][0])) { //these tags are adjacent - join them
                    tags[k][1] += tags[k + 1][1];
                    tags[k][2] += tags[k + 1][2];
                    tags.splice(k + 1, 1);
                }
