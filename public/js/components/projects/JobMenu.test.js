...
test('Items are enabled', async () => {
  ...
  expect(screen.getByText('Quality report')).toBeEnabled()
  ...
  expect(screen.getByText('Export job TMX')).toBeEnabled()
...
test('Check items href link', async () => {
  ...
  await userEvent.click(screen.getByTestId('job-menu-button'))
  const qaReportHref = screen.getByText('Quality report')
  ...
  await userEvent.click(screen.getByTestId('job-menu-button'))
  const exportTMXtHref = screen.getByText('Export job TMX')
