...
//            $('.add-mt-provider-cancel-int').click();
        ...
        $('body').on('click', 'tr.mine a.canceladdtmx, tr.ownergroup a.canceladdtmx, #inactivetm tr.new .action .addtmxfile', function() {
           ...
           UI.downloadTM( $(this).parentsUntil('tbody', 'tr'), 'downloadtmx' );
            ...
            var referenceTableId = $(this).parentsUntil('div.mgmt-container', 'table').attr('id');
            UI.showSuccessMessage( 'You will receive an email with the download link.', referenceTableId );
            setTimeout( function() {
                UI.hideSuccessMessage( referenceTableId );
            }, 6000 );
