...
//        console.log($('.upload-table tr'));
        ...
        console.log(data.files[0].type);
		 ...
		 if(extension == 'tmx') {
			 ...
			 $('.warning-message').html('A new key has been automatically generated, it will be associated to the memory you are currently loading.<br />If you already own a key and you want to use it, overwrite the autogenerated key.<br />Instead if you want to load the memory as public just erase the key.').show();
//			 return false;
		 }
