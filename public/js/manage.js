...
//            }
            ...
            $.each(this, function() {
                ...
                newJob += '        <td class="progress">'+
		            ...
		            '					<li><a target="_blank" href="/?action=downloadFile&id_job=' + this.id + '&password=' + this.password + '&id_file=&filename='+project.name+'.zip&download_type=omegat" class="download-manage"><span class="icon-download"></span>Export OmegaT</a></li>'+
        			'				</ul>'+
