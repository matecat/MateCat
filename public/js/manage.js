...
window.UI = {
  init: function () {
    ...
    TeamsStore.addListener(
      ...
      this.openChangeTeamModal.bind(this),
    )
  },
  ...
  render: function () {
    ...
    API.TEAM.getAllTeams().done(function (data) {
      ...
      self.getTeamStructure(self.selectedTeam).done(function () {
        ...
        API.PROJECTS.getProjects(self.selectedTeam, UI.Search).done(function (
          response,
        ) {
          if (
  ...
  renderProjects: function (projects) {
    ...
    if (!this.ProjectsContainer) {
      this.ProjectsContainer = ManageActions.initialRender(
        this.teams,
        this.selectedTeam,
      )
    }
  ...
  renderMoreProjects: function () {
    ...
    API.PROJECTS.getProjects(this.selectedTeam, UI.Search).done(function (
      response,
    ) {
      var projects = response.data
  ...
  showNotificationProjectsChanged: function () {
    var notification = {
      title: 'Ooops...',
      text:
        'Something went wrong, the project has been assigned to another member or moved to another team.',
      type: 'warning',
      position: 'bl',
      allowHtml: true,
      autoDismiss: false,
