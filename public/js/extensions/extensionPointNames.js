...
// The notes tab, from the whole list down to the text of one note.
export const SEGMENT_NOTES = 'segment.notes'
export const SEGMENT_NOTE = 'segment.note'
export const SEGMENT_NOTE_CONTENT = 'segment.noteContent'
export const SEGMENT_METADATA_NOTES = 'segment.metadataNotes'
export const SEGMENT_MATCH_INFO = 'segment.matchInfo'
