...
| SR-5 | Type FeatureSet dispatch       | 52 untyped hook names             | Phase 1 done: @method annotations. Hook inconsistencies resolved (5/5): param naming aligned, 3 filter→run reclassified, naming convention documented. Roadmap in `sr5-featureset-hook-typing-roadmap.md` | 🟡 Phase 1 ✅ |
