...
|--------|-------------------|--------------------------|-------|
| **PHPStan baseline entries** | 7,366 | 1,832 | −5,534 (−75.1%) |
...
**Total: 527 files** (verified via `git diff --name-only 7d529165b7...HEAD` cross-referenced with `phpstan-baseline.neon`)
