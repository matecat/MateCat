...
class INIT {
    ...
    public function __construct() {
        ...
        self::$GITHUB_OAUTH_CLIENT_ID     = @INIT::$OAUTH_CONFIG['GITHUB_OAUTH_CLIENT_ID'];
        self::$GITHUB_OAUTH_CLIENT_SECRET = @INIT::$OAUTH_CONFIG['GITHUB_OAUTH_CLIENT_SECRET'];
        self::$GITHUB_OAUTH_REDIRECT_URL  = @INIT::$OAUTH_CONFIG['GITHUB_OAUTH_REDIRECT_URL'];

        self::$LINKEDIN_OAUTH_CLIENT_ID     = @INIT::$OAUTH_CONFIG['LINKEDIN_OAUTH_CLIENT_ID'];
        self::$LINKEDIN_OAUTH_CLIENT_SECRET = @INIT::$OAUTH_CONFIG['LINKEDIN_OAUTH_CLIENT_SECRET'];
        self::$LINKEDIN_OAUTH_REDIRECT_URL  = @INIT::$OAUTH_CONFIG['LINKEDIN_OAUTH_REDIRECT_URL'];

        self::$MICROSOFT_OAUTH_CLIENT_ID     = @INIT::$OAUTH_CONFIG['MICROSOFT_OAUTH_CLIENT_ID'];
        self::$MICROSOFT_OAUTH_CLIENT_SECRET = @INIT::$OAUTH_CONFIG['MICROSOFT_OAUTH_CLIENT_SECRET'];
        self::$MICROSOFT_OAUTH_REDIRECT_URL  = @INIT::$OAUTH_CONFIG['MICROSOFT_OAUTH_REDIRECT_URL'];
