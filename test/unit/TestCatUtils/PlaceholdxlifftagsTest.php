...
class PlaceholdxlifftagsTest extends AbstractTest{
    ...
    public function testplaceholdxlifftags1() {
        $source_segment = <<<'LAB'
...
LAB;
        ...
        $this->assertEquals($expected_segment, CatUtils::placehold_xliff_tags($source_segment));
    }



    public function testplaceholdxlifftags2() {
        $source_segment = <<<'LAB'
...
LAB;
    ...
    public function testplaceholdxlifftags3() {
        $source_segment = <<<'LAB'
...
LAB;
    ...
    public function testplaceholdxlifftags4() {
        $source_segment = <<<'LAB'
...
LAB;
    ...
    public function testplaceholdxlifftags5() {
        $source_segment = <<<'LAB'
