...
class DecodeTagAttributesTest extends AbstractTest{
    ...
    /**
     * original_input= <g id="1">[AH1]</g><g id="2">Is fold &amp; crease the same??</g>
     * @see CatUtils::__decode_tag_attributes
     */
...
LAB;
        ...
        $method=$reflector->getMethod('__decode_tag_attributes');
        $method->setAccessible(true);
        $this->assertEquals($output_param,$method->invoke($x,$input_param));

    }

    /**
     * original_input= <g id="1">总之，通过对</g><g id="2">2012-2015年间美企所中国军情研究的统计和特点分析，可以做出以下判断：美企所是保守主义思想浓</g><bx id="3"/>厚的智库，对中国军事力量的正常发展观点激进，态度偏激；美企所近年来中国军情研究主要聚焦在南海、东海等海洋领土争端问题上；美企所提出的诸如加强“航行自由”、联盟体系的建议在美国政府的政策举措上有所表现。<g id="2">从上文</g><g id="3">对26篇文章的内容简述，可以清晰地看出，美企所非常关注中国海空军力的发展，并以此作为加强美军在亚太地区军力部署、更新作战概念、增加军费预算的理由。</g>
     * @see CatUtils::__decode_tag_attributes
     */
...
LAB;
    ...
    /**
     * original_input=  <g id="1">[0054] </g><g id="2">y<g id="3">(</g>z</g><g id="4">1</g><g id="5">, t</g><g id="6">m</g><g id="7">) </g><g id="8">= d - r</g><g id="9">O                                                                                                                      </g><g id="10">(Equation 11)</g>
     * @see CatUtils::__decode_tag_attributes
     */
