...
class GlossaryImportTest extends AbstractTest {
    ...
    public function test_glossaryImport_correct_behaviour() {
        ...
        $path_of_the_original_file   = INIT::$ROOT . '/test/support/files/glossary/Final-Matecat-new_glossary_format-Glossary.csv';
        $this->path_of_file_for_test = INIT::$ROOT . '/test/support/files/glossary/Final-Matecat-new_glossary_format-GlossaryCopy.csv';
    ...
    public function test_glossaryImport_wrong_target_lang() {
        ...
        $path_of_the_original_file   = INIT::$ROOT . '/test/support/files/glossary/Final-Matecat-new_glossary_format-InvalidTargetLang.csv';
        $this->path_of_file_for_test = INIT::$ROOT . '/test/support/files/glossary/Final-Matecat-new_glossary_format-InvalidTargetLangCopy.csv';
    ...
    public function test_glossaryImport_invalid_header() {
        ...
        $this->path_of_file_for_test = INIT::$ROOT . '/test/support/files/glossary/GlossaryInvalidHeaderCopy.csv';
