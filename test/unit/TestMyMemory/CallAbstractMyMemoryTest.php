...
LABEL;
        ...
        $this->array_param_of_call_for_set = array(
            'tnote' => NULL,
        ...
        $this->array_param_of_call_for_get = array(
...
TAB;
         ...
         * @var Engines_MyMemory
         */
        $engine_MyMemory = $this->getMockBuilder('\Engines_MyMemory')->setConstructorArgs(array($this->engine_struct_param_My_Memory))->setMethods(array('_call'))->getMock();
