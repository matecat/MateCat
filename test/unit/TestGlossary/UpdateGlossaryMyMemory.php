 ...
 * Time: 16.33
 */
class UpdateGlossaryMyMemory extends AbstractTest
{
    /**
    ...
    public function test_update_glossary_segment_without_key_id()
    {
        ...
        $this->config_param_of_update['translation'] = $this->translation;
    ...
    public function test_update_glossary_segment()
    {
        ...
        $this->config_param_of_update['segment'] = $this->segment;
        $this->config_param_of_update['translation'] = $this->translation;
        $this->config_param_of_update['id_user'] =array('0' => "fc7ba5edf8d5e8401593");
    ...
    public function test_update_glossary_segment_with_id_not_in_array_coverage_purpose()
    {
        ...
        $this->config_param_of_update['segment'] = $this->segment;
        $this->config_param_of_update['translation'] = $this->translation;
        $this->config_param_of_update['id_user'] = "fc7ba5edf8d5e8401593";
