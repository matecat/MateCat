...
class UpdateInsertTest extends AbstractTest
{
    ...
    public function test_insert_simple_value()
    {
        ...
        $expected = array(0 => array("PersonID" => 475144), 1 => array("PersonID" => 890788), 2 => array("PersonID" => 678432));
        $actual = $this->alfa_instance->query($this->sql_read)->fetchAll(PDO::FETCH_ASSOC);
