...
//    }
     ...
     * @throws \Exception
     */
    public function testPCWithoutDataRef() {
        ...
        $db_translation = 'Tato pravidla chování určují minimální standardy, kterými se Partnerští dopravci Uberu musí řídit při používání aplikace Uber v <pc id="source1" dataRefStart="source1">__________</pc>. Platí souběžně se všeobecnými podmínkami Uberu a <pc id="source2" dataRefStart="source2" dataRefEnd="source2"><pc id="1u" type="fmt" subType="m:u">pravidly pro komunitu Uberu</pc></pc>.';
        ...
        $expected_l1_translation = 'Tato pravidla chování určují minimální standardy, kterými se Partnerští dopravci Uberu musí řídit při používání aplikace Uber v <ph id="mtc_1" equiv-text="base64:Jmx0O3BjIGlkPSJzb3VyY2UxIiBkYXRhUmVmU3RhcnQ9InNvdXJjZTEiJmd0Ow=="/>__________<ph id="mtc_2" equiv-text="base64:Jmx0Oy9wYyZndDs="/>. Platí souběžně se všeobecnými podmínkami Uberu a <ph id="mtc_3" equiv-text="base64:Jmx0O3BjIGlkPSJzb3VyY2UyIiBkYXRhUmVmU3RhcnQ9InNvdXJjZTIiIGRhdGFSZWZFbmQ9InNvdXJjZTIiJmd0Ow=="/><ph id="mtc_4" equiv-text="base64:Jmx0O3BjIGlkPSIxdSIgdHlwZT0iZm10IiBzdWJUeXBlPSJtOnUiJmd0Ow=="/>pravidly pro komunitu Uberu<ph id="mtc_5" equiv-text="base64:Jmx0Oy9wYyZndDs="/><ph id="mtc_6" equiv-text="base64:Jmx0Oy9wYyZndDs="/>.';
        $expected_l2_segment = '';
        $expected_l2_translation = '';
