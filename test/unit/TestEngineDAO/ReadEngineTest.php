...
class ReadEngineTest extends  AbstractTest
{
    ...
    public function test_read_simple_engine_already_present_in_database()
    {
        ...
        $this->engine_struct_simple->others = array();
        ...
        $this->assertEquals(array($expected_engine_obj_output),$this->engine_Dao->read($this->engine_struct_simple));
    }
    ...
    public function test_read_engine_just_created_in_database()
    {
        ...
        $this->assertEquals(4,$result['active']); //TODO: chiedere se sia corretto che in EngineDao line 108 si abbia che il campo active venga modificato in 1 perche se è stato preimpostato a 0 allora la condizione dell'if ($obj->active == null) darà sempre TRUE. In pratica questo vuol dire che non è possibile inserire engines co active pari a 0.
