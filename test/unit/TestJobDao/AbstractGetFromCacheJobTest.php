...
class AbstractGetFromCacheJobTest extends AbstractTest
{
    ...
    public function setUp()
    {
        ...
        $this->stmt_param= $this->method_getStatementForCache->invoke($this->job_Dao,"SELECT * FROM jobs WHERE  id = :id_job AND password = :password ");
    ...
    public function test__getFromCache_engine_just_created(){
        ...
        $job_param_for_read_method=new Jobs_JobStruct(array());
