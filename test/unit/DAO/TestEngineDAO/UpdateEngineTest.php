...
class UpdateEngineTest extends AbstractTest
{
    ...
    public function setUp()
    {
        ...
        $this->sql_delete_user ="DELETE FROM ".INIT::$DB_DATABASE.".`users` WHERE uid='".$this->user_id."';";
        ...
        $this->sql_delete_engine ="DELETE FROM ".INIT::$DB_DATABASE.".`engines` WHERE id='".$this->engine_id."';";
