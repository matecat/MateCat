...
class CreateApyKeyTest extends AbstractTest
{
    ...
    public function tearDown()
    {
        ...
        $this->database_instance->query($this->sql_delete_apikey);
    ...
    public function test_create_with_success()
    {
        ...
        $this->apikey_id=$this->database_instance->last_insert();
        ...
        $wrapped_result=$this->database_instance->query($this->sql_select_apikey)->fetchAll(PDO::FETCH_ASSOC);
