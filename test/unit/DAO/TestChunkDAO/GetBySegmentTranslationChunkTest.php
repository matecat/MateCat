...
class GetBySegmentTranslationChunkTest extends AbstractTest
{
    ...
    protected $chunk_Dao;
    /**
     * @var array( Segments_SegmentStruct )
     */
    protected $segmentTranslations;
    ...
    public function setUp(){
        ...
        $this->segmentTranslations= $this->test_initializer->getSegmentTranslations();
    ...
    function test_getBySegmentTranslation()
    {
        ...
        $seg_translation_struct= new Translations_SegmentTranslationStruct($this->segmentTranslations[0]);
        $result=$this->chunk_Dao->getBySegmentTranslation($seg_translation_struct);
