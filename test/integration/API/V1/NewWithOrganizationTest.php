...
class NewWithOrganizationTest extends IntegrationTest {
    ...
    function test_api_key_without_organization_assigns_to_personal_organization() {
        ...
        $this->assertEquals( $project->id_organization, $user->getPersonalOrganization()->id ) ;
    }
