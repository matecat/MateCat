module.exports = {
  ...
  coverageThreshold: {
    ...
    './public/js/components/outsource/': {lines: 80},
    './public/js/components/projects/': {lines: 80},
    './public/js/components/common/': {lines: 80},
    './public/js/components/analyze/': {lines: 80},
    './public/js/components/review_extended/': {lines: 80},
    './public/js/hooks/': {lines: 80},
    './public/js/components/modals/': {lines: 80},
  ...
  moduleNameMapper: {
    '\\.module\\.(css|scss|sass|less)$':
      '<rootDir>/test-utils/cssModuleMock.js',
  },
}
