...
INSERT INTO engines (id, name, type, description, base_url, translate_relative_url, contribute_relative_url, update_relative_url, delete_relative_url, others, class_load, extra_parameters, google_api_compliant_version, penalty, active, uid) VALUES (2, 'ModernMT Full', 'MT', 'ModernMT for subscribers', 'http://MMT', 'translate', 'memories/content', 'memories/content',null, '{"tmx_import_relative_url":"memories/content","api_key_check_auth_url":"users/me","user_update_activate":"memories/connect","context_get":"context-vector"}', 'MMT', '{"MMT-License":"XXXXX","MMT-pretranslate":true,"MMT-preimport":false,"MMT-context-analyzer":false}', '2', 14, 1, 1886428310);
...
INSERT INTO `users` VALUES (1886428310,'domenico@translated.net','foobar','1234abcd','2024-01-01 00:00:00','Domenico','Lupinetti',NULL,NULL,NULL,NULL,'2024-01-01 00:00:00');
