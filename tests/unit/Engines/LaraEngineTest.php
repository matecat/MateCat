...
class LaraEngineTest extends AbstractTest
{
    ...
    public function getQualityEstimationSuccessReturnsFloat(): void
    {
        ...
        $result = $this->engine->getQualityEstimation('en-US', 'it-IT', 'source', 'translation', '2');
    ...
    public function memoryExistsDelegatesToClientMemoriesGet(): void
    {
        ...
        $memories = $this->getMockBuilder(\Lara\Memories::class)
    ...
    {
        $glossaries = $this->getMockBuilder(\Lara\Glossaries::class)
            ->disableOriginalConstructor()
            ->onlyMethods(['getAll'])
            ->getMock();
