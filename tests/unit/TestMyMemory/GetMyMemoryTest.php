...
TAB;
        ...
        $this->assertEquals("86%", $result->matches[1]['match']);
        ...
        $this->assertEquals(
            "http://eur-lex.europa.eu/LexUriServ/LexUriServ.do?uri=OJ:L:2007:084:0007:01:EN:HTML|@|http://eur-lex.europa.eu/LexUriServ/LexUriServ.do?uri=OJ:L:2007:084:0007:01:IT:HTML",
            $result->matches[2]['reference']
        );
     ...
     * This test certificates the righteousness of code without involving the _call method.
     *
     * Same as the preceding test BUT:
     *
     * We expect that the MT penalty management is applied to the MT match and the reordering of the matches is performed.
...
TAB;
         ...
         */
        $this->engine_MyMemory->setMTPenalty(5); // set the penalty to 5
