...
class BuildQueryForEngineTest extends AbstractTest
{
    ...
    /**
     * This test builds a SQL query for an engine with an engine struct as a param with id initialized
     * @group  regression
     * @covers EngineDAO::_buildQueryForEngine
     * @throws ReflectionException
     */
    public function test__buildQueryForEngine_with_given_engine_struct_with_ID_initialized()
    {
        ...
        $sql_query_result = $this->method->invoke($this->engineDAO, $this->engine_struct);
        $sql_query_expected = "SELECT * FROM engines WHERE id = 10";
        $this->assertEquals($sql_query_expected, $this->getRawQuery($sql_query_result));
    }

    /**
     * This test builds a SQL query for an engine with an engine struct as a param with uid initialized
     * @group  regression
     * @covers EngineDAO::_buildQueryForEngine
     * @throws ReflectionException
     */
    ...
    /**
     * This test builds a SQL query for an engine with an engine struct as a param with active initialized
     * @group  regression
     * @covers EngineDAO::_buildQueryForEngine
     * @throws ReflectionException
     */
    ...
    /**
     * This test builds a SQL query for an engine with an engine struct as a param with type initialized
     * @group  regression
     * @covers EngineDAO::_buildQueryForEngine
     * @throws ReflectionException
     */
    ...
    /**
     * This test builds a SQL query for an engine with an engine struct as a param with fake uid
     * @group  regression
     * @covers EngineDAO::_buildQueryForEngine
     * @throws ReflectionException
     */
    public function test__buildQueryForEngine_with_given_engine_struct_with_uid_fake_null()
    {
        ...
        $this->method->invoke($this->engineDAO, $this->engine_struct);
