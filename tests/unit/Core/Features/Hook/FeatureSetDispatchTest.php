...
namespace Matecat\Core\Features\Hook;
...
class TestDispatchFilterPassThrough extends BaseFeature
{
    ...
    {
        self::$invoked = true;
        if ($event instanceof \Matecat\Core\Features\Hook\DispatchFilterEvent) {
...
class TestDispatchRunHandler extends BaseFeature
{
    ...
    {
        self::$invoked = true;
        if ($event instanceof \Matecat\Core\Features\Hook\DispatchRunEvent) {
            $event->trace[] = self::FEATURE_CODE;
        }
    }
}
...
class TestDispatchPsr14PassThrough extends BaseFeature
{
    ...
    public function fromLayer0ToLayer1(object $event): void
    {
        ...
        if ($event instanceof \Matecat\Core\Features\Hook\FromLayer0ToLayer1Event) {
            $event->trace[] = self::FEATURE_CODE;
        }
    }
}
