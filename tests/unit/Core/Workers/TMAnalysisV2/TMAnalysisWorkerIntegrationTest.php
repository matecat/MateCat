...
class TMAnalysisWorkerIntegrationTest extends AbstractTest
{
    ...
    private function ensureFakeEnginesExist(): void
    {
        ...
        $conn->exec("
            ...
            VALUES
(900, 'FakeTMEngine', 'TM', 'Test', 'http://fake-tm', 'get', '{}', 'Matecat\\\\Core\\\\Workers\\\\TMAnalysisV2\\\\FakeTMEngine', '{}', 0, 1),
  (901, 'FakeMTEngine', 'MT', 'Test', 'http://fake-mt', 'get', '{}', 'Matecat\\\\Core\\\\Workers\\\\TMAnalysisV2\\\\FakeMTEngine', '{}', 0, 1)
        ");
    }
