...
namespace Matecat\Core\TestEngine;
...
class GetInstanceTest extends AbstractTest
{
    ...
    {
        $engine = EnginesFactory::getInstance($this->id_database, \Model\DataAccess\Database::obtain());
    ...
    {
        $engine = EnginesFactory::getInstance(1, \Model\DataAccess\Database::obtain());
    ...
    {
        $engine = EnginesFactory::getInstance(0, \Model\DataAccess\Database::obtain());
    ...
    {
        $this->expectException(TypeError::class);
        EnginesFactory::getInstance(null, \Model\DataAccess\Database::obtain());
    }
    ...
    public function test_getInstance_with_no_mach_for_engine_id()
    {
        ...
        EnginesFactory::getInstance($this->id_database + 1, \Model\DataAccess\Database::obtain());
    }
