...
class JSONValidatorTest extends AbstractTest
{
    ...
    {
        $jsonSchema = file_get_contents(AbstractTest::projectRoot() . '/tests/resources/files/json/schema/invalid.json');
    ...
    {
        $jsonSchema = file_get_contents(AbstractTest::projectRoot() . '/tests/resources/files/json/schema/schema_1.json');
        $invalidFile = file_get_contents(AbstractTest::projectRoot() . '/tests/resources/files/json/files/invalid.json');
    ...
    {
        $jsonSchema = file_get_contents(AbstractTest::projectRoot() . '/tests/resources/files/json/schema/schema_1.json');
        $invalidFile = file_get_contents(AbstractTest::projectRoot() . '/tests/resources/files/json/files/invalid_maxItems.json');
    ...
    {
        $jsonSchema = file_get_contents(AbstractTest::projectRoot() . '/tests/resources/files/json/schema/schema_1.json');
        $invalidFile = file_get_contents(AbstractTest::projectRoot() . '/tests/resources/files/json/files/valid.json');
    ...
    public function testValidUberQAModelFile(): void
    {
        ...
        $uberQaModel = file_get_contents(AbstractTest::projectRoot() . '/tests/resources/files/json/files/uber_qa_model.json');
    ...
    {
        $jsonSchema = file_get_contents(AbstractTest::projectRoot() . '/tests/resources/files/json/schema/schema_1.json');
        $validFile = file_get_contents(AbstractTest::projectRoot() . '/tests/resources/files/json/files/valid.json');
    ...
    {
        $invalidFile = file_get_contents(AbstractTest::projectRoot() . '/tests/resources/files/json/files/xliff_params.json');
