...
namespace Matecat\Core\Engines {
    ...
    class IntentoEngineTest extends AbstractTest
    {
        ...
        protected function setUp(): void
        {
            ...
            $this->engine = new TestIntento($struct, $this->createStub(\Model\DataAccess\IDatabase::class));
        }
        ...
        public function getRoutingListReturnsEmptyWithoutApiKey(): void
        {
            ...
            $engineWithoutApiKey = new TestIntento($struct, $this->createStub(\Model\DataAccess\IDatabase::class));
